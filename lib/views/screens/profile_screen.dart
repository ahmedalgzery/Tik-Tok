...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Update the user ID in the controller
                    ...
                    SizedBox(
                      child: Column(
                        children: [
                              ...
                              child: InkWell(
                                onTap: () {
                                  if (widget.uid == authController.user.uid) {
                                    // Handle sign-out if it's the user's own profile
                                    authController.signOut();
                                  } else {
                                    // Handle follow/unfollow for other profiles
                          ...
                          // Display the user's video thumbnails
                          GridView.builder(
                            shrinkWrap: true,
